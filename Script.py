...
ɪ ᴀᴍ ʟᴀᴛᴇꜱᴛ ᴀᴅᴠᴀɴᴄᴇᴅ ᴀɴᴅ ᴘᴏᴡᴇʀꜰᴜʟ ᴀᴜᴛᴏ ꜰɪʟᴛᴇʀ ʙᴏᴛ. ᴡɪᴛʜ ᴀᴍᴀᴢɪɴɢ ғᴇᴀᴛᴜʀᴇs ᴊᴜsᴛ ᴛʏᴘᴇ ᴡʜᴀᴛ ʏᴏᴜ ᴡᴀɴᴛ ᴛʜᴇɴ sᴇᴇ ᴍʏ ᴘᴏᴡᴇʀ ❤️‍🔥</b>"""
...
ɪ ᴀᴍ ᴀᴅᴠᴀɴᴄᴇ ᴀɴᴅ ᴘᴏᴡᴇʀғᴜʟʟ ᴀᴜᴛᴏғɪʟᴛᴇʀ ʙᴏᴛ ᴡɪᴛʜ ᴀᴍᴀᴢɪɴɢ ғᴇᴀᴛᴜʀᴇs ᴊᴜsᴛ ᴛʏᴘᴇ ᴡʜᴀᴛ ʏᴏᴜ ᴡᴀɴᴛ ᴛʜᴇɴ sᴇᴇ ᴍʏ ᴘᴏᴡᴇʀ 💘</b>"""
    ...
    HELP_TXT = """<b>ʜᴇʟʟᴏ {}
☘ मुझे इस्तेमाल करना बहुत आसान हे 😊

1. जो File चाहिए उसका का नाम भेजो (स्पेलिंग सही होनी चाहिए) 📝

      • में आपको फाइल की सारी लिंक भेज दुंगी ✅

2. जो File चाहिये हो उस की लिंक पर क्लिक करे 📩

     • में वो File भेज दूंगी ✅

3. File को आपने दोस्तों को फॉरवर्ड कर दे क्योंकि कुछ समय के बाद में File Delete कर दूंगी इसलिए 💙.</b>"""
