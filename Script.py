...
ɪ ᴀᴍ ᴀᴅᴠᴀɴᴄᴇᴅ ᴀɴᴅ ᴘᴏᴡᴇʀꜰᴜʟ ᴀᴜᴛᴏ ꜰɪʟᴛᴇʀ ʙᴏᴛ. ᴡɪᴛʜ ᴀᴍᴀᴢɪɴɢ ғᴇᴀᴛᴜʀᴇs ᴊᴜsᴛ ᴛʏᴘᴇ ᴡʜᴀᴛ ʏᴏᴜ ᴡᴀɴᴛ ᴛʜᴇɴ sᴇᴇ ᴍʏ ᴘᴏᴡᴇʀ ❤️‍🔥</b>"""
...
2. जो File चाहिये उस लिंक पर क्लिक करे 📩

     • में वो File भेज दूंगी ✅

3. File को आपने दोस्तों को फॉरवर्ड कर दे क्योंकि कुछ समय के बाद में File Delete कर दूंगी 💙.</b>"""
